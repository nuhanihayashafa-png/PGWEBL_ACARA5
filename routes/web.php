...
// Baris di bawah ini WAJIB ada agar Laravel kenal dengan PointsController
...
// Polylines - Rute untuk menyimpan data titik
Route::post('/store-polylines', [PolylinesController::class, 'store'])->name('polylines.store');

// Polygons - Rute untuk menyimpan data titik
